...
$(function(){
	...
	$.ajax({
		...
		success:function(res){
			...
			htmlStr += "<p>工作年限：<font>"+getWorkYears(res.errmsg.order.qCustomer.famillyNumber)+"</font></p>";
			htmlStr += "<p>成长阶段：<font>"+getGrowpStatus(res.errmsg.order.qCustomer.growpStatus)+"</font></p>";
