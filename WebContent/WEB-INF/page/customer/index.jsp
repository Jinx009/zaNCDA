...
<body>
<div class="nav-title">成就你专属的职场梦想</div>
...
<div style="height:15px;" ></div>
	...
	<div class="index-box" onclick="openUrl('/customer/page/caseDetail.html?id=1')" >
		<div class="index-img">
			<img src="/sp/images/case3.jpg" class="index-big"/>
	...
	<div class="index-box"  onclick="openUrl('/customer/page/caseDetail.html?id=2')" >
		<div class="index-img">
			<img src="/sp/images/case1.jpg" class="index-big"/>
	...
	<div class="index-box"  onclick="openUrl('/customer/page/caseDetail.html?id=3')" >
		<div class="index-img">
			<img src="/sp/images/case2.jpg" class="index-big"/>
