...
public class ExcelUtil {
	 ...
	 * @功能：手工构建一个简单格式的Excel
	 */
	private static List<Tutor> getTutor() throws Exception {
		List<Tutor> list = new ArrayList<Tutor>();

		Tutor tutor = new Tutor();
		tutor.setRealName("张三");
		tutor.setBankName("中国银行");
		list.add(tutor);
